...
public class MapGenerator : MonoBehaviour
{
    ...
    public void DrawMapInEditor()
    {
        ...
        {
            display.DrawMesh(MeshGeneratorScript.GenerateTerrainMesh(mapData.heightMap,
    ...
    {
        System.Random prng = new System.Random(noiseData.seed + (int)(centre.x * 1000) + (int)(centre.y * 1000));
        float islandSize = Mathf.Lerp(0.5f, 2f, (float)prng.NextDouble());
        float[,] noiseMap = Noise.GenerateNoiseMap(mapChunkSize + 2, mapChunkSize + 2, noiseData.seed,
            noiseData.noiseScale * islandSize, noiseData.octaves, noiseData.persistance, noiseData.lacunarity,
